...
static factory_manifest_entry_t s_entries[] = {
    ...
    ENTRY("spi_wsen", "WSEN WHO_AM_I and XYZ sample", FACTORY_TEST_AUTOMATIC),
    ENTRY("gpio_spi_cs1", "WSEN SPI chip select", FACTORY_TEST_AUTOMATIC),
    ENTRY("gpio_spi_sck", "WSEN SPI clock", FACTORY_TEST_AUTOMATIC),
    ENTRY("gpio_spi_mosi", "WSEN SPI MOSI", FACTORY_TEST_AUTOMATIC),
    ENTRY("gpio_spi_miso", "WSEN SPI MISO", FACTORY_TEST_AUTOMATIC),
